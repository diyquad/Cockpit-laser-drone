...
with picamera.PiCamera() as camera:
   ...
   crosshairImg = Image.open('chapeau.png')
   ...
   # Attach overlays
   topOverlay = camera.add_overlay(topOverlayImage.tobytes(), size=crosshairImg.size, layer=3, alpha=128, fullscreen=False, window=(0,20,704,60))
